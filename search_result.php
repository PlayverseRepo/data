...
<header>
  ...
  if (isset($_GET['genre_id'])) {
    ...
    $query = "SELECT gd.*
              FROM game_data gd
              INNER JOIN game_genre gg ON gd.ID_GAME = gg.ID_GAME
              INNER JOIN genre g ON gg.ID_GENRE = g.ID_GENRE
  ...
  if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM game_data WHERE GAME_NAME LIKE '%$searchTerm%'";
    $result = mysqli_query($con, $query);
